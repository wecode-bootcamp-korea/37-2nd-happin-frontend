...
### **공통**
- Nav
   - ```useNavigate```를 사용하여 검색창에 입력된 검색어를 Main페이지에 state로 전달하여 검색기능 구현

### 소셜로그인
- 카카오API를 이용한 소셜 로그인 구현


### **메인페이지**
- Masonry라이브러리를 사용하여 핀 레이아웃을 구현
- Intersection Observer를 사용해서 무한 스크롤 구현
- useSearchParams와 useLocation을 이용하여 다중 필터 기능 구현
